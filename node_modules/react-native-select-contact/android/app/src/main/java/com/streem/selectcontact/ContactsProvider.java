...
public class ContactsProvider {
    ...
    private Map<String, Contact> loadContactsFrom(Cursor cursor) {
        ...
        while (cursor != null && cursor.moveToNext()) {
            ...
            int columnIndexLookupKey = cursor.getColumnIndex(ContactsContract.Data.LOOKUP_KEY);
            int columnIndexNote = cursor.getColumnIndex(Note.NOTE);
            String contactId;
            String id;
            String rawContactId;
            String lookupKey = "";
            ...
            if (columnIndexLookupKey != -1) {
                lookupKey = cursor.getString(columnIndexLookupKey);
            }

            if (columnIndexNote != -1) {
                note = cursor.getString(columnIndexNote);
            }
